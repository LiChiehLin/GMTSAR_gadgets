...
#Example:
#
Put all three c-shell codes in MotherDirectory/
The working directory should look like this (the image folder names should be yyyymmdd):
                     images
MotherDirectory/ -> 20170202/ -> S1A_IW_SLC__1SDV_20170202T095720_20170202T095747_015103_018B14_72B8.SAFE
...
2. Batch_align.csh
Specify variable 'config' with absolute path and file name
Specify variable 'Raw' with RawFolder.dat
